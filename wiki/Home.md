...
EB plus gives you a complete desktop workflow for event-camera data: real-time visualization, camera control, recording & playback, 24 algorithms (20 self-developed + 4 OpenEB filter stages), calibration, and data export.
